  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        // fail silently per-section; tabs show empty state
      } finally {
      ...
      {/* {tab === "addresses" && (
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="flex items-center gap-1.5 text-sm font-display uppercase tracking-widest text-brand-red hover:underline">
